...
- **`blocked` and `working` both flash hard** (100% depth, 0.5 s cycle — completely dark
  to lit twice a second); the colour carries the meaning: blinking red wants you,
  blinking blue is busy.
